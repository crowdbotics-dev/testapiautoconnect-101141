...
## Project Structure
    ...
    ├── testapiautoconnect_101141  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_101141`
...
2. Clone this repo and `cd testapiautoconnect_101141`
